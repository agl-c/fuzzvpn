...
run_fuzz(){
    ...
    fuzz_log="/901runlogs/$fuzzway-$pkt-$field-$howto-$bunch-$howto-$bunch-udpproxy-$current_time.log"
    ...
    # server side tcpdump
    ser_pcap_file="/901runlogs/$fuzzway-$pkt-$field-$howto-$bunch-ser-raw-$current_time.pcap"
    ...
    cli_pcap_file="/901runlogs/$fuzzway-$pkt-$field-$howto-$bunch-cli-raw-$current_time.pcap"
    ...
    server_log="/901runlogs/$fuzzway-$pkt-$field-$howto-$bunch-server-raw-$current_time"
    server_err="/901runlogs/$fuzzway-$pkt-$field-$howto-$bunch-err-server-raw-$current_time"
    ...
    client_log="/901runlogs/$fuzzway-$pkt-$field-$howto-$bunch-client-raw-$current_time"
    client_err="/901runlogs/$fuzzway-$pkt-$field-$howto-$bunch-err-client-raw-$current_time"
