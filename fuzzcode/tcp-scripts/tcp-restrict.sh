...
run_fuzz(){
    ...
    fuzz_log="$log_dir/$fuzzway-$allowed_pkt_num-$resume_pkt_num-tcpproxy.log"
    ...
    # server side tcpdump
    ser_pcap_file="$log_dir/$fuzzway-$allowed_pkt_num-$resume_pkt_num-ser-raw.pcap"
    ...
    cli_pcap_file="$log_dir/$fuzzway-$allowed_pkt_num-$resume_pkt_num-cli-raw.pcap"
    ...
    server_log="$log_dir/$fuzzway-$allowed_pkt_num-$resume_pkt_num-server-raw"
    server_err="$log_dir/$fuzzway-$allowed_pkt_num-$resume_pkt_num-err-server-raw"
    ...
    client_log="$log_dir/$fuzzway-$allowed_pkt_num-$resume_pkt_num-client-raw"
    client_err="$log_dir/$fuzzway-$allowed_pkt_num-$resume_pkt_num-err-client-raw"
