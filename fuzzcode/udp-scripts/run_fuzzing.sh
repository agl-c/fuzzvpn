...
run_fuzz(){
    ...
    fuzz_log="/new901run/$fuzzway-$pkt-$field-$howto-$bunch-$howto-$bunch-udpproxy-$current_time.log"
    ...
    # server side tcpdump
    ser_pcap_file="/new901run/$fuzzway-$pkt-$field-$howto-$bunch-ser-raw-$current_time.pcap"
    ...
    cli_pcap_file="/new901run/$fuzzway-$pkt-$field-$howto-$bunch-cli-raw-$current_time.pcap"
    ...
    server_log="/new901run/$fuzzway-$pkt-$field-$howto-$bunch-server-raw-$current_time"
    server_err="/new901run/$fuzzway-$pkt-$field-$howto-$bunch-err-server-raw-$current_time"
